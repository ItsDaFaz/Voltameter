...
class SettingsCog(commands.Cog):
    ...
    async def settings_command(self, interaction: discord.Interaction):
        ...
        try:
            ...
            print(f"[SettingsCog] Error in settings_command: {e}", flush=True)
            await interaction.response.send_message("An error occurred while trying to display the settings menu.", ephemeral=True) 
